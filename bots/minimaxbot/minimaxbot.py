...
class MINIMAXBOT(Bot):
    ...
    def get_board_score(self, test_board):
        ...
        Returns:
            1 for a win, -1 for a loss, or 0 for a tie.
        """
    ...
    def alphabeta(self, node_board, turn, alpha, beta, depth=0):
        """The alpha-beta algorithm. This is a recursive method.

        Args:
            node_board: The board for this node.
            turn: The identity character for this turn.
            alpha: The min score.
            beta: The max score.
            depth: Number of levels deep.
                   NOTE: depth is provided only for debugging purposes.

        Returns:
            The score of the specified move.
        """
