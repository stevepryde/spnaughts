...
from game.log import log_debug, log_trace
...
class Bot:
    ...
    def __init__(self):
        """Create new Bot."""
        # This will be set to X or O.
        self.identity = ''
        # This will be set by the game runner.
        self.name = ''
    ...
    def log_debug(self, message):
        """Convenience method to log debug message with bot name."""
        log_debug("[{}]: {}".format(self.name, message))
        return

    def log_trace(self, message):
        """Convenience method to log a trace message with bot name."""
